    ...
    switch (frameData.frameFilter) {
      case FrameFilter::NONE:
        calculateFrame(frame, frameData.frameCount, frameData.frameOffset,
                       frameData.frameMeta);
        break;
      case FrameFilter::EVEN:
        calculateEvenFrame(frame, frameData.frameCount, frameData.frameOffset,
                           frameData.frameMeta);
        break;
      case FrameFilter::ODD:
        calculateOddFrame(frame, frameData.frameCount, frameData.frameOffset,
                          frameData.frameMeta);
        break;
    }
  }
