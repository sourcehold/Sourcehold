...
void Rendering::RenderText(const std::wstring& text, int32_t x, int32_t y,
                           Font type, bool illumination, double scaleFactor) {
...
void Rendering::RenderText(const std::wstring& text, Rect<int> bounds, Align al,
                           Font type, bool illumination) {
...
std::pair<uint32_t, uint32_t> Rendering::GetStringPixelDim(
    const std::wstring& text, Font type) {
