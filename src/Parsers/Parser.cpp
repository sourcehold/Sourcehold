...
uint8_t Parser::GetByte() { return stream.get(); }
...
void Parser::WriteByte(uint8_t byte) { stream.write((const char *)&byte, 1); }

void Parser::WriteWord(uint16_t word) { stream.write((const char *)&word, 2); }
