        ...
        class Event
        {
            public:
                ...
                EventType ConvertTypes(Uint32 sdlcode) {
                    switch(sdlcode) {
                        case SDL_KEYDOWN: return KEYBOARD_KEYDOWN;
                        case SDL_KEYUP: return KEYBOARD_KEYUP;
                        case SDL_MOUSEMOTION: return MOUSE_MOTION;
                        case SDL_MOUSEBUTTONDOWN: return MOUSE_BUTTONDOWN;
                        case SDL_MOUSEBUTTONUP: return MOUSE_BUTTONUP;
